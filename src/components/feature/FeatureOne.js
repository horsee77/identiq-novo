          ...
          <div className="row">
            <div className="col-lg-12">
              <div className="benefits-area-title-wrapper">
                <h3 className="title">Nossos benefícios</h3>
              </div>
            </div>
          </div>
          ...
          <div className="row g-0 mt--15">
            ...
            <div className="col-lg-3 çol-md-4 col-sm-6 col-12">
              <div className="single-benefits-area-wrapper">
                ...
                <h5 className="title">Regras configuráveis</h5>
              </div>
            </div>
            ...
            <div className="col-lg-3 çol-md-4 col-sm-6 col-12">
              <div className="single-benefits-area-wrapper bg-light">
                ...
                <h5 className="title">Menos fraude</h5>
              </div>
            </div>
            ...
            <div className="col-lg-3 çol-md-4 col-sm-6 col-12">
              <div className="single-benefits-area-wrapper">
                ...
                <h5 className="title">Mais aprovações</h5>
              </div>
            </div>
            ...
            <div className="col-lg-3 çol-md-4 col-sm-6 col-12">
              <div className="single-benefits-area-wrapper">
                <div className="icon">
                  <Icon icon="mdi:radar" width="38" height="38" />
                </div>
                <h5 className="title">Monitoramento contínuo</h5>
              </div>
            </div>
