          ...
          <div className="row mt--40 g-5">
            ...
            >
              <div className="what-we-do-main-wrapper">
                ...
                <p className="disc">
                  Explore nossas soluções de onboarding, antifraude e compliance para fintechs,
                  e commerce, marketplaces, bancos, cripto e seguros.
                </p>
                <a href="/solucoes" className="rts-btn btn-border btn-bold">
                  Ver soluções
                  <img src="../assets/images/service/icons/13.svg" alt="arrow" />
                </a>
              </div>
